...
public class Home_Kavishika extends javax.swing.JFrame {
    
    JpanelLoader jpload = new JpanelLoader();

    public Home_Kavishika() {
        initComponents();
        this.setExtendedState(Home_Kavishika.MAXIMIZED_BOTH);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Home_Kavishika.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Home_Kavishika().setVisible(true);
            }
        });
    }
