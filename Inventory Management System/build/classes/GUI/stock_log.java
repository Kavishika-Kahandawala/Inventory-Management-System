 ...
 * @author Kavishika
 */
public class stock_log extends javax.swing.JPanel {
    ...
    public void tb_load_stockin() {
        ...
        try {
            ...
            ResultSet rs = s.executeQuery(" SELECT * FROM stock_report");
    ...
    public void sortyear() {
        ...
        String comboyear = (String) combo_year.getSelectedItem();
        String yearquery = "SELECT * FROM stock_report WHERE year = '" + comboyear + "'  AND pname LIKE '%" + searchkey + "%'";
        loadrows(yearquery);
    ...
    public void sortmonth() {
        ...
        String yearquery = "SELECT * FROM stock_report WHERE year = '" + comboyear + "' AND month= '" + combomonth + "' AND pname LIKE '%" + searchkey + "%'";
        loadrows(yearquery);
    ...
    public void sortday() {
        ...
        String yearquery = "SELECT * FROM stock_report WHERE year = '" + comboyear + "' AND month= '" + combomonth + "' AND day='" + comboday + "' AND pname LIKE '%" + searchkey + "%'";
        loadrows(yearquery);
    ...
    private void txt_searchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_searchKeyReleased
        ...
        try {
            ...
            if (tgl_year.isSelected() && (!tgl_month.isSelected()) && (!tgl_day.isSelected())) {
                ...
                searchquery = "SELECT * FROM stock_report WHERE pname LIKE '%" + searchkey + "%' AND year='" + selectedyear + "' ";
            ...
            if ((tgl_month.isSelected()) && (tgl_year.isSelected()) && (!tgl_day.isSelected())) {
                ...
                searchquery = "SELECT * FROM stock_report WHERE pname LIKE '%" + searchkey + "%' AND year='" + selectedyear + "' AND month='" + selectedmonth + "' ";
                loadrows(searchquery);
            }
            ...
            if ((!tgl_month.isSelected()) && (!tgl_year.isSelected()) && (!tgl_day.isSelected())) {
                Statement s = db.mycon().createStatement();
                ResultSet rs = s.executeQuery("SELECT * FROM stock_report WHERE pname LIKE '%" + searchkey + "%'");
    ...
    private void combo_yearItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_combo_yearItemStateChanged
        // TODO add your handling code here:
        /*String comboyear = (String) combo_year.getSelectedItem();
        String yearquery = "SELECT * FROM stock_report WHERE year = '" + comboyear + "'";
        tgl_dayload();*/
    ...
    private void btn_edit1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_edit1ActionPerformed
        ...
        try {
            PdfWriter.getInstance(doc, new FileOutputStream(path + "Stock Report.pdf"));
            doc.open();
