...
public class supplier extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        s_company.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
                                ...
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            .addComponent(s_tp, javax.swing.GroupLayout.DEFAULT_SIZE, 200, Short.MAX_VALUE)
        ...
        s_table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "T.P Number", "Company", "Email"
            }
        ) {
    ...
    private void s_tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_s_tableMouseClicked
        ...
        s_search.setText(id);
        s_name.setText(name);
        s_company.setText(tp);
        s_tp.setText(company);
    ...
    private void btncupdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncupdateActionPerformed
        ...
        try {
            Statement s = db.mycon().createStatement();
            if (s_name.getText().equals("") || s_company.getText().equals("") || s_tp.getText().equals("") || s_email.getText().equals("")) {
                JOptionPane.showMessageDialog(null, "Fill Every Feild");
            } else {
