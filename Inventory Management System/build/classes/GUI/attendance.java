...
public class attendance extends javax.swing.JPanel {
    ...
    public void tb_load_attd() {

        try {

            DefaultTableModel dt = (DefaultTableModel) tbl_attd.getModel();
            dt.setRowCount(0);
    ...
    public void tgl_yearload() {
        ...
        try {
            ...
            ResultSet rsyear = syear.executeQuery(" SELECT distinct(year) FROM attendance ");
    ...
    public void sortyear() {
        ...
        String comboyear = (String) combo_year.getSelectedItem();
            ...
            String yearquery = "SELECT * FROM attendance WHERE year = '" + comboyear + "' AND employee_name LIKE '%" + searchkey + "%'";
            loadrows(yearquery);
    ...
    public void sortmonth() {
        ...
        String yearquery = "SELECT * FROM attendance WHERE year = '" + comboyear + "' AND month= '" + combomonth + "' AND employee_name LIKE '%" + searchkey + "%'";
        loadrows(yearquery);
    ...
    public void sortday() {
        ...
        String yearquery = "SELECT * FROM attendance WHERE year = '" + comboyear + "' AND month= '" + combomonth + "' AND day='" + comboday + "' AND employee_name LIKE '%" + searchkey + "%'";
        loadrows(yearquery);
    ...
    private void initComponents() {
        ...
        tbl_attd = new javax.swing.JTable();
        ...
        tbl_attd.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "AID", "Employee ID", "User Name", "Employee Name", "Date", "Time", "Role"
            }
        ) {
        ...
        jScrollPane1.setViewportView(tbl_attd);
        ...
        try {
            ...
            String searchquery = "";
                ...
                if (tgl_year.isSelected()&&(!tgl_month.isSelected())&&(!tgl_day.isSelected())) {
                    ...
                    searchquery = "SELECT * FROM attendance WHERE employee_name LIKE '%" + searchkey + "%' AND day='" + selectedyear + "'";
            loadrows(searchquery);
                ...
                if ((tgl_month.isSelected()) && (tgl_year.isSelected())&&(!tgl_day.isSelected())) {
                    ...
                    searchquery = "SELECT * FROM attendance WHERE employee_name LIKE '%" + searchkey + "%' AND year='" + selectedyear + "' AND month='" + selectedmonth + "'";
            loadrows(searchquery);
                }
                ...
                if ((tgl_month.isSelected()) && (tgl_year.isSelected()) && (tgl_day.isSelected())) {
                    ...
                    searchquery = "SELECT * FROM attendance WHERE employee_name LIKE '%" + searchkey + "%' AND year='" + selectedyear + "' AND"
                            + " month='" + selectedmonth + "' AND day='" + selectedday + "'";
            loadrows(searchquery);
            ...
            if ((!tgl_month.isSelected()) && (!tgl_year.isSelected()) && (!tgl_day.isSelected())) {
            Statement s = db.mycon().createStatement();
            ResultSet rs = s.executeQuery("SELECT * FROM attendance WHERE employee_name LIKE '%" + searchkey + "%' ");
    ...
    private void combo_yearItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_combo_yearItemStateChanged
        // TODO add your handling code here:
        /*String comboyear = (String) combo_year.getSelectedItem();
        String yearquery = "SELECT * FROM attendance WHERE year = '" + comboyear + "' ";
        tgl_dayload();*/
    ...
    private void btn_edit1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_edit1ActionPerformed
        ...
        try {
            PdfWriter.getInstance(doc, new FileOutputStream(path + "Employee Attendance.pdf"));
            doc.open();
            ...
            for (int i = 0; i < tbl_attd.getRowCount(); i++) {
                String d1 = tbl_attd.getValueAt(i, 0).toString();
                String d2 = tbl_attd.getValueAt(i, 1).toString();
                String d3 = tbl_attd.getValueAt(i, 2).toString();
                String d4 = tbl_attd.getValueAt(i, 3).toString();
                String d5 = tbl_attd.getValueAt(i, 4).toString();
                String d6 = tbl_attd.getValueAt(i, 5).toString();
                String d7 = tbl_attd.getValueAt(i, 6).toString();
    ...
    private javax.swing.JTable tbl_attd;
